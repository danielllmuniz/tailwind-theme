        ...
        >
          <div className="grid grid-cols-form gap-3">
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <Input.Root>
                <Input.Control defaultValue="Muniz" />
              </Input.Root>
            </div>
          </div>
          ...
          <div className="grid grid-cols-form gap-3 pt-5">
            ...
            <div className="gap5 flex items-start">
              <div className="flex h-16 w-16 items-center justify-center rounded-full bg-violet-50">
                <User className="h-8 w-8 text-violet-500" />
              </div>
              <label
                htmlFor="photo"
                className="hover:ng-violet-50 group flex flex-1 cursor-pointer flex-col items-center gap-3 rounded-lg border border-zinc-300 px-6 py-4 text-center text-zinc-500 shadow-sm hover:border-violet-25 hover:text-violet-500"
              >
