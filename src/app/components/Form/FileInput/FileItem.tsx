...
const fileItem = tv({
  ...
  variants: {
    state: {
      ...
      error: {
        container:
          'bg-error-25 border-error-300 dark:bg-error-500/5 dark:border-error-500/5',
        icon: 'border-error-50 bg-error-100 text-error-500 dark:bg-error-500 dark:border-error-500/30 dark:text-error-400',
        deleteButton:
        ...
        <div className="flex flex-1 flex-col items-start gap-1">
          ...
          <div className="flex w-full items-center gap-3">
            <div className="h-2 flex-1 rounded-full bg-zinc-100 dark:bg-zinc-600">
              <div
                className="dark h-2 w-4/5 rounded-full bg-violet-100"
                style={{ width: state === 'complete' ? '100%' : '80%' }}
              />
            </div>
            <span className="dark text-sm font-medium text-zinc-600 dark:bg-violet-300">
